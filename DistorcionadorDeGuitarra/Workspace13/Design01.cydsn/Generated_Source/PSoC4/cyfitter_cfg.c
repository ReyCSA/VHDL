...
static void ClockSetup(void)
{
	...
	CY_SET_REG32((void *)(CYREG_CLK_DIVIDER_A00), 0x80000009u);
...
void cyfitter_cfg(void)
{
...

	{
		static const uint32 CYCODE cy_cfg_addr_table[] = {
			...
			0x400F330Cu, /* Base address: 0x400F3300 Count: 12 */
		...
		CY_SET_REG32((void *)(CYDEV_HSIOM_BASE), 0x03333333u);
		CY_SET_REG32((void *)(CYREG_HSIOM_PORT_SEL2), 0x00030000u);
		...
		CY_SET_REG32((void *)(CYREG_UDB_PA0_CFG8), 0x2DB40000u);

		/* UDB_PA_2 Starting address: CYDEV_UDB_PA2_BASE */
		CY_SET_REG32((void *)(CYDEV_UDB_PA2_BASE), 0x00990000u);
		CY_SET_REG32((void *)(CYREG_UDB_PA2_CFG8), 0x54000000u);
	...
	CY_SET_REG32((void *)(CYDEV_PRT0_BASE), 0x0000007Fu);
	CY_SET_REG32((void *)(CYREG_PRT0_PC), 0x00DB6DB6u);

	/* IOPINS0_2 Starting address: CYDEV_PRT2_BASE */
	CY_SET_REG32((void *)(CYDEV_PRT2_BASE), 0x00000018u);
