...
module ADC_SAR_SEQ_P4_v2_50_0 (
	...
	cy_clock_v1_0
		#(.id("1945e0be-4b4d-42be-a7bd-9618f7574093/5c71752a-e182-47ca-942c-9cb20adbdf2f"),
		  .source_clock_id(""),
		  .divisor(0),
...
// IDAC_P4_v1_10(IDACRange=0, IDACValue=120, Polarity=1, Resolution=8, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=IDAC_P4_v1_10, CY_CONFIG_TITLE=DAC, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=DAC, CY_INSTANCE_SHORT_NAME=DAC, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=DAC, )
...
module top ;
	...
	wire [3:0] tmpOE__Pin_2_net;
	wire [3:0] tmpFB_3__Pin_2_net;
	wire [3:0] tmpIO_3__Pin_2_net;
	...
	cy_psoc3_pins_v1_10
		...
		Pin_2
		 (.oe(tmpOE__Pin_2_net),
		  .y({4'b0}),
		  .fb({tmpFB_3__Pin_2_net[3:0]}),
		  .io({tmpIO_3__Pin_2_net[3:0]}),
	...
	assign tmpOE__Pin_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{4'b1111} : {4'b1111};

	wire [1:0] tmpOE__Pin_3_net;
	wire [1:0] tmpFB_1__Pin_3_net;
	wire [1:0] tmpIO_1__Pin_3_net;
	wire [0:0] tmpINTERRUPT_0__Pin_3_net;
	electrical [0:0] tmpSIOVREF__Pin_3_net;

	cy_psoc3_pins_v1_10
		#(.id("02f27cf7-884f-4282-87ed-7288842f88f4"),
		...
		Pin_3
		 (.oe(tmpOE__Pin_3_net),
		  .y({2'b0}),
		  .fb({tmpFB_1__Pin_3_net[1:0]}),
		  .io({tmpIO_1__Pin_3_net[1:0]}),
	...
	assign tmpOE__Pin_3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{2'b11} : {2'b11};

	wire [1:0] tmpOE__Pin_4_net;
	wire [1:0] tmpFB_1__Pin_4_net;
	wire [1:0] tmpIO_1__Pin_4_net;
	wire [0:0] tmpINTERRUPT_0__Pin_4_net;
	electrical [0:0] tmpSIOVREF__Pin_4_net;

	cy_psoc3_pins_v1_10
		#(.id("8fbc31d5-10e8-4da1-94e9-9f590e61ac7e"),
		  .drive_mode(6'b110_110),
		  .ibuf_enabled(2'b1_1),
		  .init_dr_st(2'b0_0),
		  .input_clk_en(0),
		...
		Pin_4
		 (.oe(tmpOE__Pin_4_net),
		  .y({2'b0}),
		  .fb({tmpFB_1__Pin_4_net[1:0]}),
		  .io({tmpIO_1__Pin_4_net[1:0]}),
	...
	assign tmpOE__Pin_4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{2'b11} : {2'b11};

    IDAC_P4_v1_10_1 DAC (
        .Iout(Net_74));

	wire [5:0] tmpOE__Pin_5_net;
	wire [5:0] tmpFB_5__Pin_5_net;
	wire [5:0] tmpIO_5__Pin_5_net;
	...
	cy_psoc3_pins_v1_10
		...
		Pin_5
		 (.oe(tmpOE__Pin_5_net),
		  .y({6'b0}),
		  .fb({tmpFB_5__Pin_5_net[5:0]}),
		  .io({tmpIO_5__Pin_5_net[5:0]}),
	...
	assign tmpOE__Pin_5_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{6'b111111} : {6'b111111};

	wire [1:0] tmpOE__Pin_6_net;
	wire [1:0] tmpFB_1__Pin_6_net;
	wire [1:0] tmpIO_1__Pin_6_net;
	wire [0:0] tmpINTERRUPT_0__Pin_6_net;
	electrical [0:0] tmpSIOVREF__Pin_6_net;

	cy_psoc3_pins_v1_10
		#(.id("c21a1b8b-6368-4dfb-a19b-86480a75461d"),
		...
		Pin_6
		 (.oe(tmpOE__Pin_6_net),
		  .y({2'b0}),
		  .fb({tmpFB_1__Pin_6_net[1:0]}),
		  .io({tmpIO_1__Pin_6_net[1:0]}),
	...
	assign tmpOE__Pin_6_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{2'b11} : {2'b11};
	...
	cy_psoc3_pins_v1_10
		#(.id("28ed3aa9-cf62-4192-97f5-378efeb39ca6"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
